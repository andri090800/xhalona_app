              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    ListTile(onTap: (){Navigator.pushNamed(context, "/boking");},leading: Text("Tanggal :"),trailing: Text("12-12-2024",style: TextStyle(color: Colors.grey),),dense: true,),
                    ListTile(onTap: (){Navigator.pushNamed(context, "/boking");},leading: Text("Jam Boking :"),trailing: Text("15.00 wib",style: TextStyle(color: Colors.grey),),dense: true,),
                    ListTile(onTap: (){Navigator.pushNamed(context, "/boking");},leading: Text("Terapis :"),trailing: Text("Sinta dan Jojo",style: TextStyle(color: Colors.grey),),dense: true,),
                ],
              ),
            ),
            Divider(thickness: 5,),
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    ListTile(leading: Text("Biaya Layanan :"),trailing: Text("Rp 1.000",style: TextStyle(color: Colors.grey),),dense: true,),
